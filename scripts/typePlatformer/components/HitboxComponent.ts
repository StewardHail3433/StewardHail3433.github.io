export class HitboxComponent {
    ...
    public constructor(hitbox: {x: number; y: number; width: number; height: number}, color: {red: number; green: number; blue: number, alpha?: number} = { red: 255, green: 0, blue: 255, alpha: 1.0}) {
        this.hitbox = hitbox;
        this.color = color;
    }
